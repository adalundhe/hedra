from mercury_http.http2.response import HTTP2Response
from .event_tags import EventTagCollection


class MercuryHTTP2Event:

    def __init__(self, action: HTTP2Response):
        ...
        self._response_reason = str(self._response.error)
