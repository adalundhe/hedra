...
class GraphQLHTTP2Client(HTTP2Client[GraphQLHTTP2Action, GraphQLHTTP2Result]):
    ...
    async def request(self, action: GraphQLHTTP2Action) -> Coroutine[Any, Any, GraphQLHTTP2Result]:
