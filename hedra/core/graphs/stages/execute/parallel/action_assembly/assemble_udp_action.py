...
async def assemble_udp_action(
    ...
    hook_type_name = RequestTypes.UDP.capitalize()
    ...
    hook.session: MercuryUDPClient = registered_engines.get(RequestTypes.UDP)(
    ...
    hook.action: UDPAction = UDPAction(
        action_name,
        action_url.get('url'),
