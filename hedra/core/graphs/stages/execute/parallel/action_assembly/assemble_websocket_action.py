...
async def assemble_websocket_action(
    ...
    hook_type_name = RequestTypes.WEBSOCKET.capitalize()
    ...
    hook.session: MercuryWebsocketClient = registered_engines.get(RequestTypes.WEBSOCKET)(
    ...
    hook.action:WebsocketAction = WebsocketAction(
        action_name,
        action_url.get('url'),
