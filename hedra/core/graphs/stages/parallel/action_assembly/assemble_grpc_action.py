...
async def assemble_grpc_action(
    ...
    hook_type_name = RequestTypes.GRPC.capitalize()
    ...
    hook.session: MercuryGRPCClient = registered_engines.get(RequestTypes.HTTP2)(
    ...
    hook.action: GRPCAction = GRPCAction(
        action_name,
        action_url.get('url'),
