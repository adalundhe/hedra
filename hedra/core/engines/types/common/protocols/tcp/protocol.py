...
class TCPProtocol(FlowControlMixin, Protocol):
    ...
    def __init__(self, stream_reader, client_connected_cb=None, loop=None):
        ...
        if stream_reader is not None:
            self._stream_reader_wr: TCPReader = ref(stream_reader)
        ...
        self._stream_writer: TCPWriter = None
        self._transport: Transport = None
    ...
    @property
    def _stream_reader(self) -> TCPReader:
        if self._stream_reader_wr is None:
            return None
        return self._stream_reader_wr()

    def _replace_writer(self, writer: TCPWriter):
    ...
    def connection_made(self, transport: Transport):
        if self._reject_connection:
            ...
            return
        self._transport = transport
        reader: TCPReader = self._stream_reader
        if reader is not None:
            reader.set_transport(transport)
        self._over_ssl = transport.get_extra_info('sslcontext') is not None
        if self._client_connected_cb is not None:
            self._stream_writer = TCPReader(transport, self,
                                               reader,
                                               self._loop)
...
class TCPWriter:
    ...
    def __init__(self, transport, protocol, reader, loop):
        ...
        self._protocol: TCPProtocol = protocol
